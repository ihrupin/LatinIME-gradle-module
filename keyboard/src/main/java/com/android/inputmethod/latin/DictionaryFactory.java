...
public final class DictionaryFactory {
    ...
    protected static ReadOnlyBinaryDictionary createReadOnlyBinaryDictionary(final Context context,
        ...
        try {
            final int resId = DictionaryInfoUtils.getMainDictionaryResourceIdIfAvailableForLocale(context,
    ...
    public static boolean isDictionaryAvailable(Context context, Locale locale) {
        ...
        return 0 != DictionaryInfoUtils.getMainDictionaryResourceIdIfAvailableForLocale(context,
                res, locale);
    }
}
